...
// ※以下はサンプルなので、自身のサーバー情報を設定してください。
  ...
  $dsn = 'mysql:dbname=LAA0763593-onelinebbs;host=mysql113.phy.lolipop.lan';
  // userをロリポップのユーザー名に変更
  $user = 'LAA0763593';
    ...
    <div class="row">
      ...
      <div class="col-md-8 content-margin-top">
        <div class="timeline-centered">
          <?php foreach ($posts as $posts_each) { ?>
          ...
          <article class="timeline-entry">
              <div class="timeline-entry-inner">
                  ...
                  <div class="timeline-label">
                      <h2><a href="#"><?php echo $posts_each['nickname'];?>
                       </a> <span>
                       <?php
                        //日付の変更
                       $created = strtotime($posts_each['created']);
                       $str_created = date('Y/m/d',$created);
                       echo "$str_created";
                       ?>
                     </span></h2>
                      <p><?php echo $posts_each['comment']; ?></p>
                  </div>
              </div>
          </article>
          <?php } ?>
